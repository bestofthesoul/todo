...
# Using the format of the Student Schema with Active Record create the files needed for an Active Record project. At a minimum you should have folders for: * app * app/models * app/controllers * db * db/migrate
